...
////// Emissive:
                ...
                float3 emissive = (lerp(_Tex_Noise_var.rgb,_MainTex_var.rgb,_noisetex)*_Color.rgb*i.vertexColor.rgb*(_MainTex_var.rgb*_Mask_var.rgb)*_Color.a);
