...
Shader "Custom/waveAB2" {
    Properties {
        ...
        _noisetex ("noisetex", Range(-1, 1)) = 1
...
////// Emissive:
                ...
                float3 emissive = (lerp(_Tex_Noise_var.rgb,_MainTex_var.rgb,_noisetex)*_Color.rgb);
                float3 finalColor = emissive;
                fixed4 finalRGBA = fixed4(finalColor,(_Tex_Noise_var.a*_MainTex_var.a*i.vertexColor.r*_Color.a));
