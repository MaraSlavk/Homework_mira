...
Shader "Custom/Cylinder" {
    Properties {
        ...
        _NoiseAmmount ("NoiseAmmount", Range(0, 1)) = 0.9200325
...
////// Emissive:
                ...
                float2 node_3397 = lerp(i.uv0,lerp(float2(_Noise_var.r,_Noise_var.r),i.uv0,_NoiseAmmount),_NoiseMask_var.r);
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(node_3397, _MainTex));
                float3 emissive = (_MainTex_var.rgb*_Color.rgb*_MainTex_var.a*i.vertexColor.rgb*_Color.a);
