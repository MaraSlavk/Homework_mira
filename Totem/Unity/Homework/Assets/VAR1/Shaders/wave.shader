...
Shader "Custom/wave" {
    Properties {
        ...
        _noisetex ("noisetex", Range(-1, 1)) = 0.6960449
    }
    SubShader {
        Tags {
...
////// Emissive:
                ...
                float3 emissive = (lerp(_Tex_Noise_var.rgb,_MainTex_var.rgb,_noisetex)*_Color.rgb*i.vertexColor.rgb*(_MainTex_var.rgb*i.vertexColor.r)*_Color.a);
