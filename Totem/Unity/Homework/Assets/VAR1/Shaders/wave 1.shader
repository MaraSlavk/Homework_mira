...
Shader "Custom/waveAB" {
    Properties {
        ...
        _noisetex ("noisetex", Range(-1, 1)) = 0.7512624
...
////// Emissive:
                ...
                float3 emissive = (lerp(_Tex_Noise_var.r,_MainTex_var.r,_noisetex)*_Color.rgb);
                float3 finalColor = emissive;
                fixed4 finalRGBA = fixed4(finalColor,(_MainTex_var.a*_Color.a*i.vertexColor.r));
