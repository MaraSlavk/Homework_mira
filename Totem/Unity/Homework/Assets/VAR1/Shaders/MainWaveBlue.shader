...
////// Emissive:
                ...
                float node_842 = lerp(_Tex_Noise_var.b,_MainTex_var.b,_noisetex);
                float3 emissive = ((node_842*0.0+1.0)*_Color.rgb*_Color.a);
                float3 finalColor = emissive;
                fixed4 finalRGBA = fixed4(finalColor,(node_842*_Color.a*i.vertexColor.r*_MainTex_var.b));
